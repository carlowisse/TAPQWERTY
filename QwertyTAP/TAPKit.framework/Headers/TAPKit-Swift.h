...
- (TAPInputMode * _Nullable)getTAPInputModeForTapIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
- (void)vibrateWithDurations:(NSArray<NSNumber *> * _Nonnull)durations forIdentifiers:(NSArray<NSString *> * _Nullable)identifiers;
- (void)requestShiftAndSwitchStateForTapIdentifier:(NSString * _Nonnull)identifier;
- (void)requestShowHideKeyboardForTapIdentifier:(NSString * _Nonnull)identifier;
- (void)requestTapWithIdentifier:(NSString * _Nonnull)identifier combination:(uint8_t)combination;
- (NSInteger)getFwWithIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)getHwWithIdentifier:(NSString * _Nonnull)identifier SWIFT_WARN_UNUSED_RESULT;
- (void)readSettingsWithIdentifier:(NSString * _Nonnull)identifier;
- (void)writeSettingsWithIdentifier:(NSString * _Nonnull)identifier data:(NSData * _Nonnull)data;
- (void)setModeEnabledWhenInactiveWithEnabled:(BOOL)enabled;
@end
...
- (void)tapConnectedWithIdentifier:(NSString * _Nonnull)identifier name:(NSString * _Nonnull)name fw:(NSInteger)fw newConnection:(BOOL)newConnection serialNumberString:(NSString * _Nonnull)serialNumberString;
...
- (void)tappedWithIdentifier:(NSString * _Nonnull)identifier combination:(uint8_t)combination mTap:(uint8_t)mTap;
...
- (void)tapShiftAndSwitchStateWithIdentifier:(NSString * _Nonnull)identifier shiftState:(uint8_t)shiftState switchState:(uint8_t)switchState;
- (void)tapDidReadSettingsWithIdentifier:(NSString * _Nonnull)identifier data:(NSData * _Nonnull)data hw:(NSInteger)hw fw:(NSInteger)fw;
@end
...
SWIFT_PROTOCOL("_TtP6TAPKit17TAPKitLogDelegate_")
@protocol TAPKitLogDelegate
- (void)tapKITDidLog:(NSString * _Nonnull)line;
@end
